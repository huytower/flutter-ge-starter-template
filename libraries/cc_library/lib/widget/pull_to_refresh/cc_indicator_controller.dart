...
class CcIndicatorController extends ChangeNotifier {
  double _value;

  /// Current indicator value / progress
  double get value => _value;

  /// Creates [CcCustomRefreshIndicator] controller class
  factory CcIndicatorController({
    bool? refreshEnabled,
  }) =>
      CcIndicatorController._(refreshEnabled: refreshEnabled);

  CcIndicatorController._({
    double? value,
