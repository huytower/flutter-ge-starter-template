...
part of 'sample_code_fake_api_remote.dart';
...
class _SampleCodeFakeApiRemote implements SampleCodeFakeApiRemote {
  ...
  Future<CcResBodyModel<ResSampleCodeFakeModel>> getList() async {
    ...
    try {
      _value = CcResBodyModel<ResSampleCodeFakeModel>.fromJson(_result.data!);
    } on Object catch (e, s) {
